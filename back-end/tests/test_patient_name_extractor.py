...
def test_prefers_repeated_correct_name_over_corrupted_bilingual_line():
    markdown = """
Dados do paciente:
Nome CARLOS EDUARDO FONSECA BARBOSA Empresa EXEMPLONAV SERVIÇOS MAR TIMOS LTDA.
CPF 111.444.777-35
...
NOME: CARLOS EDUARDO FONSECA BARBOSA
Nome: CARLOS EDUARDO FONSECA BARBOSA Empresa: 500359 - CLIMED
"""

    assert (
        extract_patient_name_from_markdown(markdown)
        == "CARLOS EDUARDO FONSECA BARBOSA"
    )
