...
class Settings:
    ...
    TEXTRACT_SYNC_PAGE_RETRY_MAX = int(os.getenv("TEXTRACT_SYNC_PAGE_RETRY_MAX", 2))
    TEXTRACT_SYNC_PAGE_DELAY_SECONDS = float(os.getenv("TEXTRACT_SYNC_PAGE_DELAY_SECONDS", 0.35))
    TEXTRACT_SYNC_RETRY_BASE_DELAY_SECONDS = float(os.getenv("TEXTRACT_SYNC_RETRY_BASE_DELAY_SECONDS", 0.8))
