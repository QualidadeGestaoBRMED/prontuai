...
export function MaintenanceBanner({ maintenance, onDismiss }: MaintenanceBannerProps) {
  ...
  return (
    <div className="fixed left-0 right-0 top-3 z-[80] pointer-events-none">
      <Alert className="pointer-events-auto mx-auto flex w-[90%] max-w-7xl flex-row items-center justify-between gap-3 rounded-full border-amber-200 bg-amber-50/95 px-4 py-2 text-amber-950 shadow-lg shadow-amber-950/5 backdrop-blur">
        ...
        <Button
          ...
          variant="ghost"
          size="icon-sm"
          className="shrink-0 rounded-full text-amber-700 hover:bg-amber-100 hover:text-amber-950"
