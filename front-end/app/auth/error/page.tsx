    ...
    switch (error) {
      case "AccessDenied":
        return {
          ...
          details: "A aplicação é de uso exclusivo da BR MED. Se você acha que isso está errado, entre em contato com o time de Qualidade e Gestão para verificar suas permissões de acesso.",
        };
      case "Configuration":
        return {
